...
var generatedResources = map[string]map[string]map[string]RestResource{
	...
	"projects/datasets/tables/rowAccessPolicies": {
		"bigquery": {
			"v2": RestResource{
				...
				TypeKey:                   "projects/datasets/tables/rowAccessPolicies",
				Service:                   "bigquery",
				IsPreferredVersion:        true,
				Parameters:                []string{"resource"},
				CollectionReplacementKeys: map[string]string{},
	...
	"projects/locations/gameServerDeployments": {
		"gameservices": {
			"v1beta": RestResource{
				Name:                      "gameServerDeployments",
				TypeKey:                   "projects/locations/gameServerDeployments",
	...
	"projects/regions/inPlaceSnapshots": {
		"compute": {
			"alpha": RestResource{
				Name:               "regionInPlaceSnapshots",
				TypeKey:            "projects/regions/inPlaceSnapshots",
				Service:            "compute",
				IsPreferredVersion: false,
				Parameters:         []string{"project", "region", "resource"},
				CollectionReplacementKeys: map[string]string{
					"inPlaceSnapshots": "resource",
					"projects":         "project",
					"regions":          "region",
				},
				GetMethod: RestMethod{
					HttpMethod: "GET",
					BaseURL:    "https://compute.googleapis.com/compute/alpha/",
					Path:       "projects/{project}/regions/{region}/inPlaceSnapshots/{resource}/getIamPolicy",
				},
				SetMethod: RestMethod{
					HttpMethod:    "POST",
					BaseURL:       "https://compute.googleapis.com/compute/alpha/",
					Path:          "projects/{project}/regions/{region}/inPlaceSnapshots/{resource}/setIamPolicy",
					RequestFormat: `{"policy": %s}`,
				},
			},
		},
	...
	"projects/zones/inPlaceSnapshots": {
		"compute": {
			"alpha": RestResource{
				Name:               "zoneInPlaceSnapshots",
				TypeKey:            "projects/zones/inPlaceSnapshots",
				Service:            "compute",
				IsPreferredVersion: false,
				Parameters:         []string{"project", "zone", "resource"},
				CollectionReplacementKeys: map[string]string{
				...
				GetMethod: RestMethod{
					HttpMethod: "GET",
					BaseURL:    "https://compute.googleapis.com/compute/alpha/",
					Path:       "projects/{project}/zones/{zone}/inPlaceSnapshots/{resource}/getIamPolicy",
				},
				SetMethod: RestMethod{
					HttpMethod:    "POST",
					BaseURL:       "https://compute.googleapis.com/compute/alpha/",
					Path:          "projects/{project}/zones/{zone}/inPlaceSnapshots/{resource}/setIamPolicy",
					RequestFormat: `{"policy": %s}`,
				},
			},
		},
